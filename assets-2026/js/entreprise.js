...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function renderEntity(e) {
        ...
        if (e.description) {
            ...
            descEl.innerHTML = `<p style="color:var(--color-text-muted);font-style:italic;">Description en cours de rédaction. Pour en savoir plus, n'hésitez pas à <a href="/contact" style="color:var(--color-accent);">nous contacter</a>.</p>`;
        }
